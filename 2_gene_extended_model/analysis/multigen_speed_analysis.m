...
for i=1:length(list_genes)
    ...
    disp(mean(list_codon_times(i,1:ceil(length(list_codon_times(i,:))/10))) / mean(list_codon_times(i,ceil(length(list_codon_times(i,:))/5):end)));
    list_ratios(i) = mean(list_codon_times(i,1:ceil(length(list_codon_times(i,:))/10))) / mean(list_codon_times(i,ceil(length(list_codon_times(i,:))/5):end));
end
...
plot_speed(list_mean_times,number,generation)
end
